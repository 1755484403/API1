...
/**
 * java 集合框架
 * java.util.Collection接口，是集合的顶级接口，里面定义了集合都应当具备的功能。
 * 集合与数组一样，可以保存一组元素 ，并且对于元素的操作都以方法的形式提供的，使用方便
 * 并且集合有多种不同的数据结构可供选择
 *
 ...
 * 重复元素的判定标准为元素自身equals方法比较的结果。为true 则认为是重复元素
 */
